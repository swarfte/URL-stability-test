...
class _ResultRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      label:
          '第 ${result.sequenceNumber} 次測試，${p.label}'
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          _DetailRow(label: '開始時間', value: formatDateTime(r.startedAt)),
          _DetailRow(label: '結束時間', value: formatDateTime(r.completedAt)),
          _DetailRow(
            label: '經過時間',
          ...
          _DetailRow(label: '回傳資料大小', value: formatBytes(r.responseBytes)),
          _DetailRow(label: '重新導向次數', value: '${r.redirectCount}'),
